...
| `--kv-dtype bf16\|int8\|rk8v4\|rk4v4\|rk4v4-e8\|rk2v4-e8` | KV-cache storage; the lattice/cylinder modes (`rk4v4-e8`, `rk2v4-e8`) are lossy but fit far more context; see the "Verified Context Ceilings Matrix" in the repository README for the measured ceilings | `bf16` |
